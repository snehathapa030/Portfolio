		...
		<section className="my-28" id="contact">
			...
			<div className="md:mx-6 flex flex-col flex-wrap md:flex-row justify-between">
				<div className="md:w-6/12 md:px-0 p-5 my-5">
					<div>
						<p className="font-bold">Sneha Thapa</p>
						<p className="font-thin">Panchkula ,Haryana</p>
						<a
							href="mailto:thapasneha41gmail.com"
							className="border-b-2 mt-3 inline-block border-gray-500"
						>
							thapasneha41gmail.com
						</a>
					</div>
					<a
						className="border-b-2 mt-3 inline-block border-gray-500"
						href="./Resume - Sneha Thapa.pdf"
						target="_blank"
						rel="noreferrer"
					>
						Resume
					...
					<div className="flex flex-row flex-wrap mt-7">
						<div className="mr-4">
							<a
								href="https://www.linkedin.com/in/snehathapa030/"
								target="_blank"
								rel="noreferrer"
							>
						...
						<div className="mr-4">
							<a
								href="https://github.com/snehathapa030/"
								target="_blank"
								rel="noreferrer"
							>
								<span className="mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm">
				...
				<div className="bg-slate-900 px-5 py-10 md:py-8 sm:p-8 my-2 md:rounded-lg shadow-lg  justify-between w-full  md:w-6/12 ">
					<form
